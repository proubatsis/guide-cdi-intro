...
:figure-caption!:
:link-to-published-guide: Visit the https://openliberty.io/guides/{projectid}.html[website] for the rendered version of the guide. 
...
This bean contains two simple functions. The `get()` function is for retrieving entries from calling the `system` service,
